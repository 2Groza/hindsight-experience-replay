...
def get_args():
    ...
    parser.add_argument('--n-epochs', type=int, default=20, help='the number of epochs to train the agent')
    ...
    parser.add_argument('--reward-shift', type=float, default=0, help='reward shift')
